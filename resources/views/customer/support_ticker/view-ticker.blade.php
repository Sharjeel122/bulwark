...
<div class="container">
    ...
    <div class="row">
      <div class="col-lg-6 col-md-6  col-sm-6 col-8 my-auto">
       ...
       <div class="col-lg-6 col-md-6 col-sm-6 col-4 text-right">
            ...
            @if($ticker_info->status == 1)
             <a href="{{ route('customer.close.ticker', $ticker_info->id) }}"><label class="choose-file"><i class="fa fa-eye-slash"></i> Close Ticket </label></a>
            @else
            <a href="{{ route('customer.open.ticker', $ticker_info->id) }}"><label class="choose-file"><i class="fa fa-eye"></i> Reopen Ticket </label></a>
             @endif
        </div>    
   </div>
         <hr>
 ...
 <form  class="row py-5" action="{{ route('customer.reply.ticker' ) }}" method="post">
            @csrf
         ...
         <div class="col-md-12 col-lg-12 col-sm-12 col-12 pb-3">
          ...
          @endif
              ...
              <div class="reply-user">
                  <STRONG>{{ Auth::user()->name }} :</STRONG> {!! $ticker->message !!}
              @else
              <div class="reply-employee">
                  <STRONG>Support Team :</STRONG> {!! $ticker->message !!}
