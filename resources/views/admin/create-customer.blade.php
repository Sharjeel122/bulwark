    ...
    <div class="row">
      <div class="col-lg-6 col-md-6  col-sm-6 col-8 my-auto">
          <div class="dashboard-right-title-tag">
              <h6 class="mb-0">Create Customer</h6>         
           </div>
      </div>
       <div class="col-lg-6 col-md-6 col-sm-6 col-4 text-right">
        ...
        <form  class="account-form-style-login text-center" method="post" action="{{ route('admin.store.customer') }}">
          @csrf()
          <div class="form-group">
              <label class="form-labels" for="username"><strong>Full Name:</strong></label> 
            <input type="text" class="form-control form-feilds" name="name" placeholder="Enter Full Name">
          </div>

          <div class="form-group">
              <label class="form-labels" for="username"><strong>Email:</strong></label> 
            <input type="text" class="form-control form-feilds" name="email" placeholder="Enter Email">
          </div>

          <div class="form-group">
              <label class="form-labels" for="username"><strong>Website:</strong></label> 
            <input type="url" class="form-control form-feilds" name="website" placeholder="Website URL">
          </div>
