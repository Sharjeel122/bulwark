...
<div class="container">
    ...
    <div class="row">
      <div class="col-lg-6 col-md-6  col-sm-6 col-8 my-auto">
       ...
       <div class="col-lg-6 col-md-6 col-sm-6 col-4 text-right">
            ...
            @if($ticker_info->status == 1)
             <a href="{{ route('admin.close.ticker', $ticker_info->id) }}"><label class="choose-file"><i class="fa fa-eye-slash"></i> Close Ticket </label></a>
            @else
            <a href="{{ route('admin.open.ticker', $ticker_info->id) }}"><label class="choose-file"><i class="fa fa-eye"></i> Reopen Ticket </label></a>
             @endif
        </div>    
   </div>
         <hr>
 ...
 <form  class="row py-5" action="{{ route('admin.reply.ticker' ) }}" method="post">
            @csrf
