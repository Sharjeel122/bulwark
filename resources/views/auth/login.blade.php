        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-12 ">
            ...
            <div class="welcome-text-area text-center">
                <!-- <h2 class="text-center intro-text">Access Your Files In Just One Click</h2> -->
                     ...
                     <form method="POST" action="{{ route('login') }}" class="account-form-style-login">
                        @csrf
                        <h4 class="text-center  intro-text-small">Login</h4>
                    <div class="form-group">
                        <label class="form-labels" for="email"><strong>Email:</strong></label>
                      <input type="email" class="form-control form-feilds @error('email') is-invalid @enderror" id="exampleInputPassword1" name="email" placeholder="Enter Email" value="{{ old('email') }}">
                       @error('email')
                    ...
                    <div class="form-group">
                      ...
                      <input type="password" class="form-control form-feilds @error('password') is-invalid @enderror" name="password" id="exampleInputPassword21" placeholder="Enter Password">
                    </div>

                     <div class="text-center">
                      <button type="submit" class="btn btn-default-blue w-2">Login</button>
                      </div>
                  </form>

{{--                   <div class="text-center">--}}
{{--                      <a href="{{ route('register', 'id=1') }}" type="submit" class="btn btn-default-blue w-2">Sign Up</a>--}}
{{--                      </div>--}}
            </div>
            </div>
        </div>
