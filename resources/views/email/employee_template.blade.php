...
<body>
    <div class="container" style="width:70%; background-color: white; border: 1px solid black;">
        ...
        <div class="body" style="margin-top: 20px;">
            ...
            <h4 style="text-align: center;">Click/Paste URL for login <b><a href="https://edenspell.com/cyber-bulwark">cyber-bulwark</a></b></h4>
            ...
            <br />
            <br />
            New registration kinldy login website fo further process
        </div>
    </div>
</body>
</html>
