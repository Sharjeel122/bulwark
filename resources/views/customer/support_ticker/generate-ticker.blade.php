    ...
    <div class="row">
      <div class="col-lg-6 col-md-6  col-sm-6 col-8 my-auto">
          <div class="dashboard-right-title-tag">
              <h6 class="mb-0">Generate Ticket</h6>         
           </div>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-6 col-4 text-right">
        ...
        <form  class="row" action="{{ route('customer.send.ticker' ) }}" method="post">
            @csrf
            ...
            <button type="submit" class="btn btn-default-blue w-2">Send</button>
        </div>
        </form>
